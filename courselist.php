...
<div class="sidenav" id="mySidenav" style="padding-top: 90px;">
    ...
    <a href="test_courselist.php">Course List</a>
    ...
    <tbody>
        ...
        if ($results) {
            foreach ($results as $row) {
                ...
                <td>' . $dep . '</td>
                <td>
                <button class="update-btn"><a href="test_updateCourse.php?updateid=' . $Cid . '">Update</a></button>
                <button class="delete-btn"><a href="test_deleteCourse.php?deleteid=' . $Cid . '">Delete</a></button>
                </td>
                </tr>';
            }
        }
