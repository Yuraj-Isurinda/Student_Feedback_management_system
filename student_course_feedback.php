...
<body>
    ...
    <div class="row">
        ...
        <?php
        $stmt = $pdo->query("SELECT Category,Content,QuestionID FROM question where Type='C'");
        $currentCategory = null;
        ?>
        
        <div class="row align-items-center py-4 px-5"  id="6">
        <form method="post" action="student_course_feedback_process.php">
