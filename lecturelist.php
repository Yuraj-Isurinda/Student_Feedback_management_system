    ...
    <tbody>
        ...
        try {
            ...
            foreach ($lecturers as $row) {
                ...
                echo '<tr>
                <th scope="row">' . htmlspecialchars($Lid) . '</th>
                <td>' . htmlspecialchars($fname) . '</td>
                <td>' . htmlspecialchars($lname) . '</td>
                <td>' . htmlspecialchars($email) . '</td>
                <td>' . htmlspecialchars($did) . '</td>
                <td>
                <button class="update-btn"><a href="updateLecturer.php?updateid=' . htmlspecialchars($Lid) . '">Update</a></button>
                <button class="delete-btn"><a href="deleteLecturer.php?deleteid=' . htmlspecialchars($Lid) . '">Delete</a></button>
                </td>
                </tr>';
            }
